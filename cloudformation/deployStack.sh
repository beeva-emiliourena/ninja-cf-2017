...
# Params
ANWBIS_PROJECT="formacion"
ANWBIS_ENVIRONMENT="${CF_ENVIRONMENT}"
ANWBIS_ROLE="developer"
CF_BUCKET="projectfoo-infra-${CF_ENVIRONMENT}"
CF_DIR="cloudformation"
CF_PROJECT="projectfoo"
AWS_REGION="eu-west-1"
AWS_COMMAND="aws --region ${AWS_REGION} --profile ${ANWBIS_PROJECT}-dev-${ANWBIS_ROLE}"
...
# Assume role.
anwbis -p ${ANWBIS_PROJECT} -e dev -r ${ANWBIS_ROLE} || exit 1
